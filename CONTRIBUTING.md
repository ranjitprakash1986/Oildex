...
with the owner of this repository listed on the [README.md](README.md) before making a change.
...
5. Ensure any temporary files are removed before committing, and that a `.gitignore` file is updated to ignore any new temporary files, that you may have created.
6. After you have committed your changes to your repostiory, create a pull request to the `main` branch of the original repository. A pull request will be looked at by the maintainers of the repository, and if it is approved, it will be merged into the `main` branch.
